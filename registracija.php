    ...
    <div class="container">
        <div class="row vh-100 d-flex align-items-center">
            <div class="col-6 mx-auto">
                <h1 class="text-center mb-5">Registruj se</h1>
                <form action="./src/reg.php" method="post">

                <div class="form-group">
                        <label for="korisnicko_ime" class="form-label">Vase Korisnicko Ime:</label>
                        <input type="text" name="korisnicko_ime" class="form-control">
                    </div>

                    <div class="form-group my-3">
                        <label for="ime" class="form-label">Vase Ime:</label>
                        <input type="text" name="ime" class="form-control">
                    </div>


                    <div class="form-group my-3">
                        <label for="email" class="form-label">Vas Email:</label>
